                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-2 text-center m-auto">
                                <span
                                    style="--tblr-avatar-size: 8rem; background-image: url(@if (Auth::user()->avatar) {{ asset(Auth::user()->avatar) }} @else https://api.proxeuse.com/avatars/api/?name={{ urlencode(Auth::user()->name) }}&color=fff&background={{ substr(md5(Auth::user()->name), 0, 6) }}&size=500 @endif)"
